...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "total_upvotes_received", sa.Integer(), nullable=False, server_default="0"
        ),
        sa.Column(
            "total_downvotes_received", sa.Integer(), nullable=False, server_default="0"
        ),
        sa.Column(
            "total_upvotes_given", sa.Integer(), nullable=False, server_default="0"
        ),
        sa.Column(
            "total_downvotes_given", sa.Integer(), nullable=False, server_default="0"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "suno_status", sa.String(50), nullable=False, server_default="pending"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "is_priority_boost", sa.Boolean(), nullable=False, server_default="0"
        ),
        ...
        sa.ForeignKeyConstraint(
            ["user_id"], ["users.id"], name=op.f("fk_radio_queue_user_id_users")
        ),
        sa.ForeignKeyConstraint(
            ["song_id"], ["songs.id"], name=op.f("fk_radio_queue_song_id_songs")
        ),
    )
    op.create_index(op.f("ix_radio_queue_user_id"), "radio_queue", ["user_id"])
    op.create_index(
        op.f("ix_radio_queue_telegram_user_id"), "radio_queue", ["telegram_user_id"]
    )
    ...
    op.create_index(
        op.f("ix_radio_queue_priority_score"), "radio_queue", ["priority_score"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "upvotes_during_play", sa.Integer(), nullable=False, server_default="0"
        ),
        sa.Column(
            "downvotes_during_play", sa.Integer(), nullable=False, server_default="0"
        ),
        ...
        sa.ForeignKeyConstraint(
            ["song_id"], ["songs.id"], name=op.f("fk_radio_history_song_id_songs")
        ),
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["user_id"], ["users.id"], name=op.f("fk_votes_user_id_users")
        ),
        sa.ForeignKeyConstraint(
            ["queue_item_id"],
            ["radio_queue.id"],
            name=op.f("fk_votes_queue_item_id_radio_queue"),
        ),
